...
export const auditCaseData: AuditCase[] = [
  ...
  { key: '1',  caseId: 'PRAPYID_2601010001', invoiceNo: 'INV-2025-0001', supplierName: 'Accenture Pte Ltd',              region: 'SEA',   entity: 'SG', amount: 145000, currency: 'SGD', invoiceDate: '2025-01-05', reviewDate: '2025-01-07', isGolden: 'Golden',     groundTruth: 'Pass',    tags: ['three-way-match', 'header-check'] },
  { key: '2',  caseId: 'PRAPYID_2601080002', invoiceNo: 'INV-2025-0002', supplierName: 'AWS Singapore Pte Ltd',         region: 'SEA',   entity: 'SG', amount: 87200,  currency: 'SGD', invoiceDate: '2025-01-08', reviewDate: '2025-01-10', isGolden: 'Golden',     groundTruth: 'Fail',    tags: ['amount-mismatch'] },
  { key: '3',  caseId: 'PRAPYID_2601120003', invoiceNo: 'INV-2025-0003', supplierName: 'Google Asia Pacific Pte Ltd',   region: 'SEA',   entity: 'TH', amount: 320000, currency: 'THB', invoiceDate: '2025-01-12', reviewDate: '2025-01-14', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['line-item', 'tax-check'] },
  { key: '4',  caseId: 'PRAPYID_2601150004', invoiceNo: 'INV-2025-0004', supplierName: 'Microsoft Thailand Co Ltd',     region: 'SEA',   entity: 'TH', amount: 215000, currency: 'THB', invoiceDate: '2025-01-15', reviewDate: '2025-01-17', isGolden: 'Golden',     groundTruth: 'Pass',    tags: ['golden', 'three-way-match'] },
  { key: '5',  caseId: 'PRAPYID_2601200005', invoiceNo: 'INV-2025-0005', supplierName: 'Deloitte Advisory Vietnam',     region: 'SEA',   entity: 'VN', amount: 98000,  currency: 'VND', invoiceDate: '2025-01-20', reviewDate: '2025-01-22', isGolden: 'Non-Golden', groundTruth: 'Pending', tags: ['under-review'] },
  { key: '6',  caseId: 'PRAPYID_2602010006', invoiceNo: 'INV-2025-0006', supplierName: 'Alibaba Cloud (HK) Ltd',        region: 'EA',    entity: 'TW', amount: 56000,  currency: 'TWD', invoiceDate: '2025-02-01', reviewDate: '2025-02-03', isGolden: 'Golden',     groundTruth: 'Pass',    tags: ['header-check'] },
  { key: '7',  caseId: 'PRAPYID_2602050007', invoiceNo: 'INV-2025-0007', supplierName: 'Tencent Cloud International',   region: 'EA',    entity: 'TW', amount: 134000, currency: 'TWD', invoiceDate: '2025-02-05', reviewDate: '2025-02-07', isGolden: 'Non-Golden', groundTruth: 'Fail',    tags: ['bank-mismatch', 'amount-mismatch'] },
  { key: '8',  caseId: 'PRAPYID_2602100008', invoiceNo: 'INV-2025-0008', supplierName: 'Mercado Pago Brasil',           region: 'LATAM', entity: 'BR', amount: 47000,  currency: 'BRL', invoiceDate: '2025-02-10', reviewDate: '2025-02-12', isGolden: 'Golden',     groundTruth: 'Pass',    tags: ['golden', 'three-way-match'] },
  { key: '9',  caseId: 'PRAPYID_2602140009', invoiceNo: 'INV-2025-0009', supplierName: 'Shopee Philippines Inc',        region: 'SEA',   entity: 'PH', amount: 290000, currency: 'PHP', invoiceDate: '2025-02-14', reviewDate: '2025-02-16', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['line-item'] },
  { key: '10', caseId: 'PRAPYID_2602200010', invoiceNo: 'INV-2025-0010', supplierName: 'Shopee Indonesia PT',           region: 'SEA',   entity: 'ID', amount: 185000, currency: 'IDR', invoiceDate: '2025-02-20', reviewDate: '2025-02-22', isGolden: 'Golden',     groundTruth: 'Fail',    tags: ['golden', 'tax-check'] },
  { key: '11', caseId: 'PRAPYID_2603010011', invoiceNo: 'INV-2025-0011', supplierName: 'AWS Singapore Pte Ltd',         region: 'SEA',   entity: 'MY', amount: 62000,  currency: 'MYR', invoiceDate: '2025-03-01', reviewDate: '2025-03-03', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['header-check'] },
  { key: '12', caseId: 'PRAPYID_2603050012', invoiceNo: 'INV-2025-0012', supplierName: 'Accenture Pte Ltd',             region: 'SEA',   entity: 'SG', amount: 210000, currency: 'SGD', invoiceDate: '2025-03-05', reviewDate: '2025-03-07', isGolden: 'Golden',     groundTruth: 'Pending', tags: ['golden', 'under-review'] },
  // ── Older cases (reviewDate > 365 days ago, eligible for archiving) ──
  { key: '13', caseId: 'PRAPYID_2401100013', invoiceNo: 'INV-2024-0041', supplierName: 'Accenture Pte Ltd',             region: 'SEA',   entity: 'SG', amount: 132000, currency: 'SGD', invoiceDate: '2024-01-10', reviewDate: '2024-01-12', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['three-way-match'] },
  { key: '14', caseId: 'PRAPYID_2401180014', invoiceNo: 'INV-2024-0042', supplierName: 'AWS Singapore Pte Ltd',         region: 'SEA',   entity: 'SG', amount: 73400,  currency: 'SGD', invoiceDate: '2024-01-18', reviewDate: '2024-01-20', isGolden: 'Non-Golden', groundTruth: 'Fail',    tags: ['amount-mismatch'] },
  { key: '15', caseId: 'PRAPYID_2402050015', invoiceNo: 'INV-2024-0043', supplierName: 'Google Asia Pacific Pte Ltd',   region: 'SEA',   entity: 'SG', amount: 98500,  currency: 'SGD', invoiceDate: '2024-02-05', reviewDate: '2024-02-07', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['header-check'] },
  { key: '16', caseId: 'PRAPYID_2402140016', invoiceNo: 'INV-2024-0044', supplierName: 'Tencent Cloud International',   region: 'EA',    entity: 'TW', amount: 120000, currency: 'TWD', invoiceDate: '2024-02-14', reviewDate: '2024-02-16', isGolden: 'Non-Golden', groundTruth: 'Fail',    tags: ['bank-mismatch'] },
  { key: '17', caseId: 'PRAPYID_2403020017', invoiceNo: 'INV-2024-0045', supplierName: 'Mercado Pago Brasil',           region: 'LATAM', entity: 'BR', amount: 38000,  currency: 'BRL', invoiceDate: '2024-03-02', reviewDate: '2024-03-04', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['three-way-match'] },
  { key: '18', caseId: 'PRAPYID_2403100018', invoiceNo: 'INV-2024-0046', supplierName: 'Microsoft Thailand Co Ltd',     region: 'SEA',   entity: 'TH', amount: 190000, currency: 'THB', invoiceDate: '2024-03-10', reviewDate: '2024-03-12', isGolden: 'Non-Golden', groundTruth: 'Pass',    tags: ['line-item'] },
  // Golden case older than 365 days — retained in active list (not archivable)
  { key: '19', caseId: 'PRAPYID_2401250019', invoiceNo: 'INV-2024-0047', supplierName: 'Accenture Pte Ltd',             region: 'SEA',   entity: 'SG', amount: 175000, currency: 'SGD', invoiceDate: '2024-01-25', reviewDate: '2024-01-27', isGolden: 'Golden',     groundTruth: 'Pass',    tags: ['golden', 'three-way-match'] },
]
